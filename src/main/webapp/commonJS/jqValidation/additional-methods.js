...
jQuery.validator.addMethod("Loginalphanumeric", function(value, element) {
...
jQuery.validator.addMethod("invalidspace", function(value, element) {
...
jQuery.validator.addMethod("invalidmenu", function(value, element) {
...
jQuery.validator.addMethod("minAmount", function(value, element, param) {
	return this.optional(element) || value - 0 >= param;
},jQuery.format("请输入大于等于零的金额值"));

//扩展jquery校验金额规则
//jQuery.validator.addMethod("maxAmount", function(value, element, param) {
//	return this.optional(element) || value.length - 0 < param;
//},jQuery.format("请输入小于11位金额值"));
...
jQuery.validator.addMethod("costStlye", function(value, element, param) {
	if(param===0){
		var innerval = $('#costStlye').children('option:selected').val();
		if(innerval==='0'){
			if(!$(element).val()){
				return false;
			}else{
...
},jQuery.format("此字段为必输"));



//jQuery.validator.addMethod("maxLength", function(value, element, param) {
//		return this.optional(element) || value.length - 0 < param;
//},jQuery.format("字段长度不正确,请输入不大于32位的字符"));

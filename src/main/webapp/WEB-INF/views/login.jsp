	...
	<shiro:notAuthenticated>	
		...
		<div class="navbar">
			<div class="navbar-inner">
				<div class="container">
					<img alt="" src="images/logo-screen-noglow.png" style="height: 45px; padding-top: 5px; padding-bottom: 5px;">
				</div>
			</div>
		</div>
		<center>
						...
						<div class="controls">
							<div class="input-append">
								<input id="captcha" type="text" name="captcha" 
								    class="input-large" style="width:152px;" maxlength="32" />						
								<img id="captcha-img"  class="add-on" style="padding: 0px 0px;height:28px;">
								<input id="captcha-hidden" type="hidden" value="<%=path%>"/>
							</div>
						</div>
					</div> 

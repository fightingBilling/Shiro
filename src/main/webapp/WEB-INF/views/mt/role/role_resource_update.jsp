...
<body>
	...
	<input type="hidden" name="resourceRoleId" id="resourceRoleId" value="${param.resourceRoleId}" />
	<input type="hidden" name="resourceRoleName" id="resourceRoleName" value="${param.resourceRoleName}" />
	...
	<div class="row">
		...
		<div class="control-group span4">
		<label class="control-label" for="role_name">资源搜索</label>
		<input type="text" name="urlPatten" value="${param.urlPatten}" id="urlPatten" />
		<button name="queryButton" type="button" class="btn btn-success">搜索</button>
		</div>
	</div>
	</div>
	<div class="container" style="width:90%">
	...
	<div class="container" style="width:90%">
		<div class="span2.2">
			<button name="role_resource_submit"  type="button" class="btn btn-success">提交</button>
